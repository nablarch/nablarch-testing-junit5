 ...
 */
public class BatchRequestTestExtension extends TestEventDispatcherExtension<BatchRequestTestSupport> {
    @Override
    protected BatchRequestTestSupport createSupport(Object testInstance, ExtensionContext context) {
